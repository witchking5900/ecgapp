...
ka: {
    ...
    NSR: { 
      ...
      desc: "გულის სტანდარტული რიტმი. ელექტრული იმპულსი წარმოიქმნება SA კვანძში და ვრცელდება ნორმალურად.", 
      tip: "შეამოწმეთ: არის თუ არა P ყველა QRS-ის წინ? ნორმალურია თუ არა სიხშირე?",
      clinical: "მკურნალობას არ საჭიროებს. ფიზიოლოგიური ნორმა.",
      reg: "რეგულარული", p: "არსებობს, დადებითი", qrs: "ვიწრო"
    },
    VFIB: { 
      name: "პარკუჭოვანი ფიბრილაცია", 
      desc: "ქაოსური, არარეგულარული დეფლექციები სხვადასხვა ამპლიტუდით. პარკუჭები მხოლოდ თრთის და არ იკუმშება.", 
      tip: "ქაოსური ხაზები. სტრუქტურის გარეშე. დაუყოვნებლივ დეფიბრილაცია!",
      clinical: "კრიტიკული მდგომარეობა. გულის გაჩერება. საჭიროა CPR და დეფიბრილაცია. ფატალურია თუ არ უმკურნალეთ.",
      reg: "სრულიად არარეგულარული", p: "არ არის", qrs: "არ არის"
    },
    AFLUT: { 
      name: "წინაგულთა თრთოლვა", 
      desc: "მაკრო-რიენტრის წრედი მარჯვენა წინაგულში. დამახასიათებელი 'ხერხის კბილისებრი' თრთოლვის ტალღები.", 
      tip: "ეძებეთ 'ხერხის კბილის' მსგავსი ტალღები QRS კომპლექსებს შორის.",
      clinical: "სიხშირის კონტროლი (ბეტა-ბლოკერები), რიტმის კონტროლი (კარდიოვერსია/აბლაცია). ინსულტის პრევენცია.",
      reg: "რეგულარული (ხშირად)", p: "ხერხის კბილისებრი 'F' ტალღები", qrs: "ვიწრო"
    },
    WPW: { 
      name: "ვოლფ-პარკინსონ-უაიტი", 
      desc: "პრე-ეგზიტაციის სინდრომი. დამატებითი გზა (კენტის კონა) გვერდს უვლის AV კვანძს. ნიშნები: მოკლე PR, დელტა ტალღა.", 
      tip: "მოკლე PR + დელტა ტალღა (დახრილი აღმავალი შტრიხი) = განიერი QRS.",
      clinical: "SVT-ს ან სწრაფი Afib-ის რისკი. მოერიდეთ AV კვანძის ბლოკერებს (ABCD) თუ Afib არსებობს. აბლაცია კურნავს.",
      reg: "რეგულარული", p: "ნორმალური", qrs: "განიერი, დელტა ტალღით"
    },
    PVC_MONO: { 
      name: "მონომორფული PVC", 
      desc: "ექტოპიური დარტყმა, რომელიც წარმოიქმნება პარკუჭების ერთი კერიდან.", 
      tip: "განიერი, უცნაური კომპლექსი, რომელიც ნაადრევად მოდის. ყველა ერთნაირია.",
      clinical: "ჯანმრთელ გულში საშიში არაა. უმკურნალეთ გამომწვევ მიზეზს (ელექტროლიტები). ხშირმა PVC-მ შეიძლება კარდიომიოპათია გამოიწვიოს.",
      reg: "არარეგულარული (ნაადრევი)", p: "არ არის", qrs: "განიერი, უცნაური"
    },
    PVC_POLY: { 
      name: "პოლიმორფული PVC", 
      desc: "PVC-ები, რომლებიც წარმოიქმნება პარკუჭების სხვადასხვა კერებიდან. აქვთ განსხვავებული ფორმები.", 
      tip: "რამდენიმე განიერი, უცნაური კომპლექსი, რომლებიც განსხვავებულად გამოიყურება. არასტაბილურია.",
      clinical: "მიუთითებს ელექტრულ არასტაბილურობაზე. შეამოწმეთ ელექტროლიტები (K, Mg). R-on-T ფენომენის რისკი.",
      reg: "არარეგულარული (ნაადრევი)", p: "არ არის", qrs: "განიერი, ცვალებადი"
    },
    PAC_HIGH: { 
      name: "PAC (მაღალი წინაგული)", 
      desc: "ექტოპიური კერა წინაგულის ზედა ნაწილში. დადებითი P-კბილი, ნაადრევი დარტყმა.", 
      tip: "ნაადრევი დარტყმა დადებითი P-კბილით (ნორმალურს ჰგავს).",
      clinical: "კეთილთვისებიანი. პროვოცირდება სტრესით, კოფეინით, ალკოჰოლით ან თამბაქოთი.",
      reg: "არარეგულარული (ნაადრევი)", p: "ნაადრევი და დადებითი", qrs: "ვიწრო"
    },
    PAC_MID: { 
      name: "PAC (შუა წინაგული)", 
      desc: "ექტოპიური კერა წინაგულის შუა ნაწილში. ბიფაზური P-კბილი.", 
      tip: "ნაადრევი დარტყმა ბიფაზური (ზემოთ/ქვემოთ) P-კბილით.",
      clinical: "კეთილთვისებიანი. განასხვავეთ სინუსური არითმიისგან. შეამცირეთ ტრიგერები.",
      reg: "არარეგულარული (ნაადრევი)", p: "ნაადრევი და ბიფაზური", qrs: "ვიწრო"
    },
    PAC_LOW: { 
      name: "PAC (დაბალი წინაგული)", 
      desc: "ექტოპიური კერა წინაგულის ქვედა ნაწილში. რეტროგრადული (ინვერსიული) P-კბილი.", 
      tip: "ნაადრევი დარტყმა ინვერსიული (უარყოფითი) P-კბილით.",
      clinical: "კეთილთვისებიანი. განასხვავეთ კვანძოვანი რიტმებისგან.",
      reg: "არარეგულარული (ნაადრევი)", p: "ნაადრევი და ინვერსიული", qrs: "ვიწრო"
    },
    LBBB: { 
      name: "მარცხენა ფეხის ბლოკადა", 
      desc: "ბლოკადა ჰისის კონის მარცხენა ფეხში. განიერი, დეფორმირებული R V5-V6-ში.", 
      tip: "WiLLiam: W V1-ში, M V6-ში. განიერი, დეფორმირებული QRS.",
      clinical: "ასოცირდება გულის სტრუქტურულ დაავადებებთან. ახალი LBBB + ტკივილი გულმკერდში = STEMI (სგარბოსას კრიტერიუმები).",
      reg: "რეგულარული", p: "არსებობს", qrs: "განიერი, დეფორმირებული ('M')"
    },
    RBBB: { 
      name: "მარჯვენა ფეხის ბლოკადა", 
      desc: "ბლოკადა ჰისის კონის მარჯვენა ფეხში. RSR' პატერნი V1-ში.", 
      tip: "MaRRoW: M V1-ში (კურდღლის ყურები), W V6-ში. განიერი QRS.",
      clinical: "შეიძლება იყოს ნორმის ვარიანტი ან გამოწვეული იყოს ფილტვის არტერიის თრომბოემბოლიით, იშემიით.",
    ...
    AVB1: { 
      ...
      tip: "PR ინტერვალი > 5 პატარა უჯრაზე (0.20წმ). მუდმივი.",
      clinical: "ჩვეულებრივ უსიმპტომოა. სპეციფიკურ მკურნალობას არ საჭიროებს, მაგრამ საჭიროა დაკვირვება.",
      reg: "რეგულარული", p: "ნორმალური, PR > 0.20წმ", qrs: "ვიწრო"
    },
    AVB2T1: { 
      name: "AV ბლოკადა II (ტიპი 1)", 
      desc: "ვენკებახი. PR-ის პროგრესული გახანგრძლივება კომპლექსის ჩავარდნამდე.", 
      tip: "გრძელდება, გრძელდება, გრძელდება, ჩავარდნა! (ვენკებახი).",
      clinical: "ხშირად გამოწვეულია AV კვანძის შექცევადი ბლოკით (მედიკამენტები, ვაგუსის ტონუსი). ხშირად კეთილთვისებიანია.",
      reg: "არარეგულარული (დაჯგუფებული)", p: "პროგრესული PR", qrs: "ვიწრო, პერიოდული ჩავარდნით"
    },
    AVB2T2: { 
      name: "AV ბლოკადა II (ტიპი 2)", 
      desc: "მობიტც II. შემთხვევითი ჩავარდნები PR-ის გახანგრძლივების გარეშე.", 
      tip: "თუ ზოგიერთი P ვერ გადის, მაშინ გაქვს მობიტც II.",
      clinical: "სრული ბლოკადის განვითარების მაღალი რისკი. ჩვეულებრივ საჭიროა პეისმეიკერი. ატროპინი ხშირად უეფექტოა.",
      reg: "არარეგულარული ჩავარდნები", p: "მუდმივი სიხშირე", qrs: "ვიწრო ან განიერი"
    },
    AVB3: { 
      name: "AV ბლოკადა III (სრული)", 
      desc: "გულის სრული ბლოკადა. AV დისოციაცია.", 
      tip: "P და QRS გაყრილნი არიან. სრული დისოციაცია.",
      clinical: "გადაუდებელი მდგომარეობა. ასისტოლიის რისკი. საჭიროა პეისმეიკერი. ატროპინი ზოგადად უეფექტოა.",
      reg: "რეგულარული (დისოცირებული)", p: "ნორმალური, დისოცირებული", qrs: "განიერი (ჩანაცვლებითი)"
    },
    SSS: { 
      name: "სინუსის სისუსტის სინდრომი", 
      desc: "SA კვანძის დისფუნქცია. ტაქიკარდიის ეპიზოდები რომელსაც მოსდევს პაუზები.", 
      tip: "სწრაფი ეპიზოდები, შემდეგ გრძელი პაუზები (ტაქი-ბრადი).",
      clinical: "ხშირად საჭიროა პეისმეიკერი ბრადიკარდიისთვის და მედიკამენტები ტაქიკარდიისთვის.",
      reg: "არარეგულარული (პაუზები)", p: "ნორმალური", qrs: "ვიწრო"
    },
    LAH: { 
      name: "მარცხენა წინაგულის ჰიპერტროფია", 
      desc: "P-მიტრალე. განიერი, დეფორმირებული P-კბილი.", 
      tip: "P-მიტრალე: 'M' ფორმის P-კბილი II განხრაში.",
      clinical: "უმკურნალეთ გამომწვევ მიზეზს (ჰიპერტენზია, სარქვლოვანი დაავადება). Afib-ის რისკი.",
      reg: "რეგულარული", p: "ორკუზიანი 'M' ფორმა", qrs: "ვიწრო"
    },
    RAH: { 
      name: "მარჯვენა წინაგულის ჰიპერტროფია", 
      desc: "P-პულმონალე. მაღალი P-კბილი.", 
      tip: "P-პულმონალე: მაღალი, წვეტიანი P-კბილი (>2.5მმ).",
      clinical: "უმკურნალეთ ფილტვის ან გულის გამომწვევ მიზეზს (COPD, ფილტვის ჰიპერტენზია).",
      reg: "რეგულარული", p: "მაღალი და წვეტიანი", qrs: "ვიწრო"
    },
    SB: { 
      name: "სინუსური ბრადიკარდია", 
      desc: "ნორმალური რიტმი < 60 დარტყმა/წთ.", 
      tip: "ნორმალური რიტმი, უბრალოდ ნელი (<60).",
      clinical: "ჩვეულებრივ საშიში არაა (ატლეტები/ძილი). უმკურნალეთ მხოლოდ თუ სიმპტომურია.",
      reg: "რეგულარული", p: "არსებობს", qrs: "ვიწრო"
    },
    ST: { 
      name: "სინუსური ტაქიკარდია", 
      desc: "ნორმალური რიტმი > 100 დარტყმა/წთ.", 
      tip: "ნორმალური რიტმი, უბრალოდ სწრაფი (>100).",
      clinical: "უმკურნალეთ გამომწვევ მიზეზს (სითხეები, სიცხის დამწევი, ტკივილგამაყუჩებელი, შფოთვა).",
      reg: "რეგულარული", p: "არსებობს", qrs: "ვიწრო"
    },
    AFIB: { 
      name: "წინაგულთა ფიბრილაცია", 
      desc: "წინაგულების ქაოსური აქტივობა. არარეგულარულად არარეგულარული.", 
      tip: "არარეგულარულად არარეგულარული. P-კბილები არ ჩანს. არეული იზოხაზი.",
      clinical: "სიხშირის კონტროლი, რიტმის კონტროლი, ანტიკოაგულაცია (ინსულტის პრევენცია).",
      reg: "სრულიად არარეგულარული", p: "არ არის", qrs: "ვიწრო"
    },
    VT: { 
      name: "პარკუჭოვანი ტაქიკარდია", 
      desc: "განიერკომპლექსიანი ტაქიკარდია.", 
      tip: "განიერი, სწრაფი და რეგულარული. საფლავის ქვებს ჰგავს.",
